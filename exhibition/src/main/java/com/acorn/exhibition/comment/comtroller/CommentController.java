package com.acorn.exhibition.comment.comtroller;
...
public class CommentController {
	...
	// 댓글 저장 요청 처리
		...
		public Map<String, Object> com_updateLikeCount(HttpServletRequest request, @ModelAttribute CommentDto dto) {
			Map<String, Object> result=commentservice.com_updateLikeCount(request);
			return result;
		}
}
